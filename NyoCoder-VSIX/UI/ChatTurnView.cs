...
namespace NyoCoder
{
    ...
    public sealed class ChatTurnView : Border
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs args)
        {
            ...
            if (_scrollViewer != null) _scrollViewer.ScrollChanged += OnScrollChanged;
            if (double.IsNaN(Height)) ShowDocument();
            else UpdateVisibility();
            if (Turn != null) Turn.SetViewActive(true);
        }
        ...
        private void OnUnloaded(object sender, RoutedEventArgs args)
        {
            if (_scrollViewer != null) _scrollViewer.ScrollChanged -= OnScrollChanged;
            _scrollViewer = null;
            if (_editor != null) Height = ActualHeight;
            if (Turn != null) Turn.SetViewActive(false);
            Detach(Turn);
        }
        ...
        private void ShowDocument()
        {
            ...
            _editor.SetResourceReference(Control.ForegroundProperty, Microsoft.VisualStudio.Shell.VsBrushes.WindowTextKey);
