...
namespace NyoCoder
{
    ...
    public class ContextEngine
    {
        ...
        /// </summary>
        public static string GetSystemPrompt(string modeId)
        {
            return ModeRegistry.GetSystemPrompt(modeId);
        }
        ...
        /// </summary>
        public static int GetBaseCharacterOverhead(string modeId = ModeIds.Agent)
        {
            int overhead = GetSystemPrompt(modeId).Length;
            overhead += ToolDefinitions.GetToolDefinitionsLength(modeId);
            return overhead;
        }
        ...
        public static int ApproximateTokens(int characterCount, string modeId = ModeIds.Agent)
        {
            int totalCharacters = characterCount + GetBaseCharacterOverhead(modeId);
